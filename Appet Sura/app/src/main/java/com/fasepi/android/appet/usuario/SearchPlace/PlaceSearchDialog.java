package com.fasepi.android.appet.usuario.SearchPlace;
...
public class PlaceSearchDialog extends AppCompatDialog implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, View.OnClickListener {
    ...
    private static LatLngBounds BOUNDS_WORLD = new LatLngBounds(
            new LatLng(4.473276, -74.17540), new LatLng(4.818605, -74.023325));
    ...
    private void buildDialog() {
        ...
        okTV.setTextColor(builder.positiveTextColor != 0 ? ContextCompat.getColor(context, builder.positiveTextColor) : ContextCompat.getColor(context, R.color.colorNegro));
        cancelTV.setTextColor(builder.negativeTextColor != 0 ? ContextCompat.getColor(context, builder.negativeTextColor) : ContextCompat.getColor(context, R.color.colorNegro));
        locationET.setHintTextColor(builder.hintTextColor != 0 ? ContextCompat.getColor(context, builder.hintTextColor) : ContextCompat.getColor(context, R.color.colorNegro));
        ...
        if (builder.headerImageResource != 0) {
            ...
            headerImageIV.setImageResource(R.drawable.login);
        }
